...
<head>
  ...
  <title>rootorial | Data Transaksi</title>
                  ...
                  <div class="row">
                      ...
                      <div class="col col s8 m8 l8">
                          <ul id="profile-dropdown" class="dropdown-content">
                              ...
                              <li><a href="logout.php" onclick="konfirmasi()"><i class="mdi-hardware-keyboard-tab"></i> Logout</a>
                              </li>
                          </ul>
      ...
      <section id="content">
            ...
            <div class="row">
              <div class="col s12 m12 l12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Data Post dan Penulis</li>
                </ol>
              </div>
            </div>
          </div>
        ...
        <div class="container">
          <div class="section">
            ...
            <p class="caption">Berbagai macam tutorial yang akan penulis tampilkan berada disini, silahkan cek bila ada update-an baru, tutorial yang baru saja dibuat</p>
            ...
            <div id="card-widgets" class="section">
              <div class="row">
                <?php
                  $result = mysql_query("SELECT * FROM contents_administrator");
                        ...
                        <div class="card-panel grey lighten-5 z-depth-1">
                          <div class="row valign-wrapper">
                            <div class="col s8 m10">
                              <center><span class="black-text">Jumlah tutorial yang Ada sebanyak : <b><?php echo $num_rows; ?></b> Buah</span></center>
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                $articles = "SELECT * FROM contents_administrator ORDER BY kd_tutor desc LIMIT $start, $perPage";
                $result2 = mysql_query("$articles");
                $result = mysql_query("SELECT * FROM contents_administrator");
                ...
                <div class="col s12 m12 l4">
                  ...
                  <div id="profile-card" class="card">
                    <div class="card-image waves-effect waves-block waves-light">
                      <img class="activator" src="gambar/<?php echo $r['gambar'];?>" alt="user bg">
                    </div>
                    <div class="card-content">
                      <div class="col s1">
                        <img src="<?php echo $grav_kedua;?>" alt="" class="circle responsive-img activator card-profile-image">
                      </div>

                      <a class="btn-floating activator btn-move-up waves-effect waves-light darken-2 right tooltiped2" data-position="top" data-delay="50" data-tooltip="Enter Me if you want to approve post" data-activates="status" href='prosesApprove.php?id=<?php echo $id; ?>'>
                        <i class="mdi-navigation-check"></i>
                      </a>
                      <script>
          $(document).ready(function(){
            $('.tooltiped2').tooltip({delay: 50});
          });
          </script>
                      <p class="row">
                        <tr>
                          <td><?php echo $r['jenis_bhs']; ?></td>
                          <td>:</td>
                          <td><span style="font-size: 14px;"><?php echo $r['cat_info']; ?></span><br /></td>
                        </tr>
                      </p>

                      <h6 style="font-size:18px;" class="card-title grey-text text-darken-4">
                        <?php echo "<a href='../isi_content/baca_detail.php?id=$encrypt' class='grey-text text-darken-2'>";?>
                          <?php echo $r['judul_tutor']; ?>
                        <?php echo "</a>"; ?>
                      </h6>
                      <p class="row">
                          <span><small><?php echo $r['nama_admin']; ?></small></span> | <span style="font-size:10pt;">Ditulis sejak : <?php echo TanggalIndo($r['tgl_publish']); ?></span>
                      </p>
                      <?php
                        echo "<a class='btn-floating btn-middle waves-effect waves-light blue tooltipped' type='submit' name='hapus' href='delete-tutorial.php?id=$id' data-position='top' data-delay='50' data-tooltip='Delete'>
                          <i class='large mdi-action-delete'></i>
                        </a>";
                      ?>
                      <?php
                      echo "<a class='btn-floating btn-middle waves-effect waves-light orange tooltipped' type='submit' name='update' href='form-buatupdate.php?id=$id' data-position='right' data-delay='50' data-tooltip='Update'>
                    ...
                    <div class="row">
                      <div class="col s12 m8 l12">
                        <div class="card-panel grey lighten-5 z-depth-1">
                          <div class="row valign-wrapper">
                            <div class="col s8 m10">
                              <center><span class="black-text">Tidak ada tutorial yang ditampilkan</span></center>
                            </div>
                          </div>
                        </div>
                      </div>
                         ...
                         <div class="row valign-wrapper">
                           <div class="col s8 m10">
                             <ul class="pagination">
                               ...
                               ?>
                                 <li class="waves-effect"><a href="<?php echo $url;?>"><i class="mdi-hardware-keyboard-arrow-left
"></i></a></li>
                               <?php for($i = 1; $i <=$pages; $i++){ ?>
                                 <li class="waves-effect active"><a href="?halaman=<?php echo $i?>" ><?php echo $i ?></a></li>
                             <?php  } ?>
                             <li class="waves-effect">dari total page : <?php echo $pages; ?></li>
                             </ul>
                           </div>
                         </div>
                       </div>
        ...
        <div class="fixed-action-btn" style="bottom: 45px; right: 24px;">
          <a class="btn-floating btn-large waves-effect waves-light indigo tooltipped" href="form-buattutor.php" data-position="left" data-delay="50" data-tooltip="Press Me for plus tutorial">
            <i class="large mdi-editor-mode-edit"></i>
          </a>
          <script>
          $(document).ready(function(){
