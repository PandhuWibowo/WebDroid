      ...
      <section id="content">
        ...
        <div class="container">
          <div class="section">
            ...
            <p class="caption">Masukkan Moderator baru yang akan Anda input</p>
            ...
            <div class="row">
              ...
              <div class="col s12 m12 l6">
                <div class="card-panel">
                  <div class="row">
                      <form class="col s12" method="post" action="form_mod-proses.php">
                      <div class="row">
                      ...
                      <div class="row">
                        <div class="input-field col s12">
                          ...
                          <label for="instagram">Instagram(Simpan link saja)</label>
                        </div>
                      </div>
                      <div class="row">
                        <div class="input-field col s12">
                          ...
                          <label for="facebook">Facebook(Simpan link saja)</label>
                        </div>
                      </div>
                      <div class="row">
                        <div class="input-field col s12">
                          ...
                          <label for="twitter">Twitter(Simpan link saja)</label>
                        </div>
                      </div>
                      <div class="row">
                        <div class="input-field col s12">
                          <i class="mdi-communication-contacts prefix"></i>
                          <input id="G_Plus" type="text" name="g_plus"  class="validate">
                          <label for="G_Plus">Google Plus(Simpan link saja)</label>
                        </div>
                      </div>
                      <div class="row">
                        <div class="input-field col s12">
