...
<body class="indigo">
  ...
  <div id="login-page" class="row">
    <div class="col s12 z-depth-10 card-panel">
      <form class="login-form" method="post" action="login_admin-proses.php">
        <h4><b>Detail Bahasa Pemrograman</b></h4>
        <div class="row margin">
          <div class="input-field col s12">
            <tr>
              <td><b>Kode Bahasa Pemrograman</b></td>
              <td>:</td>
        ...
        <div class="row margin">
          <div class="input-field col s12">
            <tr>
              <td><b>Nama Bahasa Pemrograman</b></td>
              <td>:</td>
              <td><?php echo $nama; ?></td>
            </tr>
          </div>
  ...
  <div class="fixed-action-btn" style="bottom: 45px; right: 24px;">
    <a class="btn-floating btn-large waves-effect waves-light red tooltipped" href="app-email.php" data-position="left" data-delay="50" data-tooltip="Press Me for back to table category">
