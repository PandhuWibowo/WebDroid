...
<head>
  ...
  <title>mejacoding | Data Form</title>
...
<body>
            ...
            <div class="row">
              ...
              <div class="col s12 m12 l6">
                <div class="card-panel">
                  <div class="row">
                    <form class="col s12" method="post" action="category_Update-proses.php">
                      <div class="row">
                        <div class="input-field col s12">
                          <i class="mdi-hardware-keyboard-control prefix"></i>
                          <input id="kd_cat" readonly="" type="text" class="validate" name="kd_cat" value="<?php echo $decrypt; ?>">
                      ...
                      <div class="row">
                        <div class="input-field col s12">
                          ...
                          <input id="nama_cat" type="text" class="validate" name="nama_cat" value="<?php echo $nama; ?>">
                          <label for="nama_cat">Nama</label>
                        </div>
                      </div>
                      <div class="row">
                        <div class="row">
  ...
  <footer class="page-footer indigo">
    <div class="footer-copyright">
      <div class="container">
        <span>Copyright © 2017 <a class="grey-text text-lighten-4">mejacoding</a> All rights reserved.</span>
