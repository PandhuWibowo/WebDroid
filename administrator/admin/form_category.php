            ...
            <div class="row">
              ...
              <div class="col s12 m12 l6">
                <div class="card-panel">
                  <div class="row">
                    <form class="col s12" method="post" action="category-proses.php">
                      <div class="row">
                        <div class="input-field col s12">
                          <i class="mdi-hardware-keyboard-control prefix"></i>
                          <input id="kd_cat" type="text" class="validate" name="kd_cat" disabled="">
                          <label for="kd_cat">Kode Sudah Terisi Otomatis</label>
                        </div>
                      </div>
                      <div class="row">
                        <div class="input-field col s12">
                          <i class="mdi-social-person-add prefix"></i>
                          <input id="nama_cat" type="text" class="validate" name="nama_cat" required>
                          <label for="nama_cat">Nama Category Minat</label>
                        </div>
                      </div>
                      <div class="row">
                        <div class="row">
                          <div class="input-field col s12">
                            ...
                            <button class="btn indigo waves-effect waves-light right" type="submit" name="simpan">SIMPAN
