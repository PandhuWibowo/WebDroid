    ...
    <div class="wrapper">
      ...
      <section id="content">
            ...
            <div class="row">
              <div class="col s12 m12 l12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Data Kategori Minat</li>
                </ol>
              </div>
            </div>
          </div>
        ...
        <div class="container">
          <div class="section">
            ...
            <div id="table-datatables">
              <h4 class="header">DataTables Kategori Minat</h4>
              <div class="row">
                  ...
                  <table id="data-table-simple" class="responsive-table display" cellspacing="0">
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                            <td><?php echo  $no;?></td>
                            <td><?php echo $r['kd_kat']; ?></td>
                            <td><?php echo $r['nama_cat']; ?></td>
                            <td>
                              <?php
                                echo "<a class='btn-floating btn-middle waves-effect waves-light red tooltipped' type='submit' name='update' href='form-category_Update.php?id=$encrypt' data-position='left' data-delay='50' data-tooltip='Update'>
                                  <i class='large mdi-editor-mode-edit'></i>
                                </a>";
                              ?>
                              <?php
                                echo "<a class='btn-floating btn-middle waves-effect waves-light blue tooltipped' type='submit' name='hapus' href='delete-category.php?id=$id' data-position='top' data-delay='50' data-tooltip='Delete'>
                                  <i class='large mdi-action-delete'></i>
                                </a>";
                              ?>
                              <?php
                                echo "<a class='btn-floating btn-middle waves-effect waves-light orange tooltipped' type='submit' name='view' href='view-category.php?id=$encrypt' data-position='right' data-delay='50' data-tooltip='View Detail'>
        ...
        <div class="fixed-action-btn" style="bottom: 45px; right: 24px;">
          <a class="btn-floating btn-large waves-effect waves-light red tooltipped" href="form_category.php" data-position="left" data-delay="50" data-tooltip="Press Me for plus category">
            <i class="large mdi-editor-mode-edit"></i>
          </a>
          <script>
          $(document).ready(function(){
