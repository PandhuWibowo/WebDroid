...
$sql = $con->query("SELECT * FROM informasi_bayar");
                $sql->execute();
                $inBa = $sql->fetchAll();
...
<title>Report Informasi Bayar</title>
...
<p>Laporan Informasi Bayar </p>
    <table cellspacing="0" style="width: 100%; border: solid 1px black; background: #E7E7E7; text-align: center; font-size: 10pt;">
        <tr>
            <th style="width: 5%; text-align: left">No</th>
            <th style="width: 19%; text-align: left">ID Tes</th>
            <th style="width: 26%; text-align: left">Jumlah Bayar</th>
        </tr>
    </table>
<?php
    $i = 1;
...
?>
    <table cellspacing="0" style="width: 100%; border: solid 1px black; background: #F7F7F7; text-align: center; font-size: 10pt;">
        <tr>
            ...
            <td style="width: 26%; text-align: left"><?php echo "Rp.".number_format($jml_bayar); ?></td>
        </tr>
    </table>
<?php
    $i++;
