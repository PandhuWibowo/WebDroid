    ...
    <div class="wrapper">
      ...
      <section id="content">
            ...
            <div class="row">
              <div class="col s12 m12 l12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Data Moderator</li>
                </ol>
              </div>
            </div>
          </div>
        ...
        <div class="container">
          <div class="section">
                    ...
                    <div class="card-panel grey lighten-5 z-depth-1">
                      <div class="row valign-wrapper">
                        <div class="col s8 m10">
                          <center><span class="black-text">Jumlah moderator yang Ada sebanyak : <b><?php echo $num_rows; ?></b> Orang</span></center>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div id="table-datatables">
              <h4 class="header">DataTables Moderator</h4>
              <div class="row">
                ...
                <div class="col s12 m8 l12">
                  ...
                  <table id="data-table-simple" class="responsive-table display" cellspacing="0">
                    ...
                    <tbody>
                      ...
                      include "koneksi.php";
                      $sql = mysql_query('SELECT * FROM moderator');
                      $no = 1;
                      ...
                      ?>
                        <tr>
                            ...
                            <td><?php echo $r['jen_kel']; ?></td>
                            <td><?php echo $r['status']; ?></td>
                            <td>
                              <?php
                                echo "<a class='btn-floating btn-middle waves-effect waves-light red tooltipped' type='submit' name='view' href='user_profile_admin/profile.php?id=$encrypt' data-position='left' data-delay='50' data-tooltip='View Detail'>
                                  <i class='large mdi-action-face-unlock'></i>
                                </a>";
                              ?>
                              <?php
                                echo "<a class='btn-floating btn-middle waves-effect waves-light blue tooltipped' type='submit' name='hapus' href='delete-moderator.php?id=$id' data-position='top' data-delay='50' data-tooltip='Delete'>
                                  <i class='large mdi-action-delete'></i>
                                </a>";
                              ?>
                              <button class="btn-floating btn-middle waves-effect waves-light orange tooltipped" type="submit" name="update" href="#" data-position="right" data-delay="50" data-tooltip="Update">
        ...
        <div class="fixed-action-btn" style="bottom: 45px; right: 24px;">
          <a class="btn-floating btn-large waves-effect waves-light indigo tooltipped" href="form-layouts.php" data-position="left" data-delay="50" data-tooltip="Press Me for plus moderator">
            <i class="large mdi-editor-mode-edit"></i>
          </a>
          <script>
          $(document).ready(function(){
