      ...
      <form class="login-form">
        <div class="row">
          <div class="input-field col s12 center">
            <img src="<?php echo $grav_url; ?>" alt="" class="circle responsive-img valign profile-image-login">
            <h4 class="header"><?php echo $r['nama']; ?></h4>
          </div>
        </div>
        ...
        <div class="row">
          <div class="input-field col s12">
            <a href="index.html" class="btn waves-effect waves-light col s12">Login Kembali</a>
          </div>
        </div>
        <div class="row">
          <div class="input-field col s6 m6 l12">
              <p class="margin right-align medium-small right"><a href="page-login.php" onclick="return konfirmasi()">Log Out? </a></p>
          </div>
        </div>
