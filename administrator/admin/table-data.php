      ...
      <section id="content">
        ...
        <div class="container">
          <div class="section">
            ...
            <?php
              $result = mysql_query("SELECT * FROM penulis");
                    ...
                    <div class="card-panel grey lighten-5 z-depth-1">
                      <div class="row valign-wrapper">
                        <div class="col s8 m10">
                          <center><span class="black-text">Jumlah penulis yang Ada sebanyak : <b><?php echo $num_rows; ?></b> Orang</span></center>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div id="table-datatables">
              <h4 class="header">DataTables Penulis</h4>
              <div class="row">
                ...
                <div class="col s12 m8 l12">
                  <table id="data-table-simple" class="responsive-table display" cellspacing="0">
                    ...
                    <tbody>
                      ...
                      include "koneksi.php";
                      $sql = mysql_query('SELECT *, TIMESTAMPDIFF(YEAR, tgl_lhr, CURDATE()) AS usia FROM penulis');
                      $no = 1;
                      ...
                      ?>
                        <tr>
                            <td><?php echo $no; ?></td>
                            <td><?php echo $r['nm_lkp']; ?></td>
                            <td><?php echo $r['email']; ?></td>
                            <td><?php echo $r['no_handphone']; ?></td>
                            <td><?php echo $r['usia']; ?></td>
                            <td>Aktif</td>
                            <td>
                              <button class="btn-floating btn-middle waves-effect waves-light red tooltipped" type="submit" name="update" href="#" data-position="left" data-delay="50" data-tooltip="Update">
                                <i class="large mdi-editor-mode-edit"></i>
                              </button>
                              <?php
                                echo "<a class='btn-floating btn-middle waves-effect waves-light blue tooltipped' type='submit' name='hapus' href='delete-penulis.php?id=$id' data-position='top' data-delay='50' data-tooltip='Delete'>
